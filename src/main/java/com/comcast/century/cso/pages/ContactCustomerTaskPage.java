...
public class ContactCustomerTaskPage extends Page {

	public ContactCustomerTaskPage(WebDriver browser, SeleniumReport report) {
	...
	public boolean ContactCustomer(){
		try{
			if(waitForElement(NextContactDate)){
