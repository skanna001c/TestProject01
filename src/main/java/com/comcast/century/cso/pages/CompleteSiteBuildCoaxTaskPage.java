...
public class CompleteSiteBuildCoaxTaskPage extends Page {
	//String windowHandle = browser.getWindowHandle();
	
	public CompleteSiteBuildCoaxTaskPage(FrameworkContext context) {
		super(context);
	}
	...
	Logger log = Logger.getLogger(CompleteSiteBuildCoaxTaskPage.class);
	...
	public boolean ClickCompleteButton(){		
		try{
			if(waitForElement(btnComplete)){
				...
				iClick(btnComplete, null, "Complete CompleteSiteBuildCoax Task: Complete CompleteSiteBuildCoax Task: CompleteButton");
