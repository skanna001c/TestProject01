...
import com.comcast.reporting.ReportTheme;

public class ReportThemeFactory
{
	/**
	 * Enum to specify the colour theme for the reports
	 */
	public enum Theme
	{
		CLASSIC, MYSTIC, AUTUMN, OLIVE, REBEL, RETRO, SERENE,TQM
	}
	...
	public static ReportTheme getReportsTheme(Theme theme)
	{
		...
		case MYSTIC:
			...
			reportTheme.setContentForeColor("#FFFFFF");
			break;
		...
		case TQM:
			reportTheme.setHeadingBackColor("#92D050");
			reportTheme.setHeadingForeColor("#58ACFA");
			reportTheme.setSectionBackColor("#8B9292");
			reportTheme.setSectionForeColor("#FFFFFF");
		//	reportTheme.setContentForeColor("#996600");
		//	reportTheme.setContentBackColor("#F8F1E7");
		break;
	}
